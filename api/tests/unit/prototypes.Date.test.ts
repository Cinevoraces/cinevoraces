...
describe('prototypes/Date.ts', () => {
    it('firstDayOfYear()', () => {
        expect(Date.firstDayOfYear(0, 2025).toUTCString().startsWith('Sat')).toBe(true);
        expect(Date.firstDayOfYear(1, 2025).toUTCString().startsWith('Sun')).toBe(true);
        expect(Date.firstDayOfYear(2, 2025).toUTCString().startsWith('Mon')).toBe(true);
        expect(Date.firstDayOfYear(3, 2025).toUTCString().startsWith('Tue')).toBe(true);
        expect(Date.firstDayOfYear(4, 2025).toUTCString().startsWith('Wed')).toBe(true);
        expect(Date.firstDayOfYear(5, 2025).toUTCString().startsWith('Thu')).toBe(true);
        expect(Date.firstDayOfYear(6, 2025).toUTCString().startsWith('Fri')).toBe(true);
