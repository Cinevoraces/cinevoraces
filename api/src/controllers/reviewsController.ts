...
import { ESchemasIds, EReview, EAddReview, EUpdateReview, EErrorMessages, EResponseMessages } from '../models/enums/_index';
  ...
  fastify.route({
    ...
    handler: async function (
      request: Request<{
        ...
        Body: Record<keyof Pick<dbReview, 'bookmarked' | 'viewed' | 'liked' | 'rating' | 'comment'>, boolean | number | string>,
      }>, reply: Reply) {
