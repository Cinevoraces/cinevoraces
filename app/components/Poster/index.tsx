...
enum PosterStyles {
  ...
  caroussel = 'rounded-xl w-full h-full object-cover shadow-lg hover:scale-105 transition duration-150 hover:ease-out fourth-child:hidden fifth-child:hidden sixth-child:hidden md:fourth-child:block lg:fifth-child:block xl:sixth-child:block',
